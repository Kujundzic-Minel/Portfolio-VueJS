  ...
  <nav class="m-4 sticky top-[30px] z-50 HeaderAnimation">
    ...
    <div v-show="isOpen" class="md:hidden">
      <ul class="bg-[#353232] bg-opacity-25 rounded-lg p-4 mt-2 space-y-2 text-white text-sm">
        ...
        <li class="list-none hover:font-semibold" @click="scrollToSkills">
          Skills
        </li>
        <li class="list-none hover:font-semibold" @click="scrollToProjects">
          Project
        </li>
        <li class="list-none hover:font-semibold">
          <RouterLink to="/whoiam">Who I am</RouterLink>
        </li>
        <RouterLink to="../pages/contact.vue"
          ><div
